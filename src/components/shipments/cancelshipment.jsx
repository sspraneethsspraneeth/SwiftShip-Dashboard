...
const Cancelshipment = ({ show, onClose, onSave }) => {
  ...
  return (
    ...
    >
      <Modal.Header closeButton className="btn border-0 pb-1">
        <Modal.Title className="fw-bold fs-5">Cancel Shipment</Modal.Title>
      </Modal.Header>
      <Modal.Body className="pt-0">
        <Form>
          <Form.Group controlId="noteTextarea">
            <Form.Label className="fw-medium mb-2">Are you sure you want to cancel this sipment?</Form.Label>
            <Form.Control
              as="textarea"
              rows={4}
